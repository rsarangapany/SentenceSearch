...
{
    internal class EnglishStemmerService: IStemmerService
    {
        ...
        private readonly string[] _exceptionsPart2 = { "inning", "outing", "canning", "herring", "earring", "proceed", "exceed", "succeed" };

        private readonly string[] _exceptionsRegion1 = { "gener", "arsen", "commun" };

        private char[] Alphabet { get; } = Enumerable.Range('a', 'z' - 'a' + 1).Select(c => (char)c).Concat(new[] { '\'' }).ToArray();

        private char[] Vowels { get; } = "aeiouy".ToArray();

        private string[] Doubles { get; } = { "bb", "dd", "ff", "gg", "mm", "nn", "pp", "rr", "tt" };

        private char[] LiEndings { get; } = "cdeghkmnrt".ToArray();
        ...
        /// <summary>
        /// Determines whether the specified c is vowel.
        /// </summary>
        /// <param name="c">The c.</param>
        /// <returns>
        ///   <c>true</c> if the specified c is vowel; otherwise, <c>false</c>.
        /// </returns>
        ...
        /// <summary>
        /// Determines whether the specified c is consonant.
        /// </summary>
        /// <param name="c">The c.</param>
        /// <returns>
        ///   <c>true</c> if the specified c is consonant; otherwise, <c>false</c>.
        /// </returns>
        ...
        /// </summary>
        /// <param name="word">The word.</param>
        /// <param name="oldSuffix">The old suffix.</param>
        /// <param name="newSuffix">The new suffix.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Step0s the remove s plural suffix.
        /// </summary>
        /// <param name="word">The word.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Step1s a remove other s plural suffixes.
        /// </summary>
        /// <param name="word">The word.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Step1s the b remove ly suffixes.
        /// </summary>
        /// <param name="word">The word.</param>
        /// <param name="r1">The r1.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Step1s the c replace suffix y with i if preceeded with consonant.
        /// </summary>
        /// <param name="word">The word.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Step4s the remove some suffixes in r2.
        /// </summary>
        /// <param name="word">The word.</param>
        /// <param name="r2">The r2.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Step5s the remove eor l suffixes.
        /// </summary>
        /// <param name="word">The word.</param>
        /// <param name="r1">The r1.</param>
        /// <param name="r2">The r2.</param>
